...
import { subscribeToPush, getPushStatus } from '@/hooks/use-sessions'
				...
				<section>
					...
					<div className="space-y-1 text-xs">
						<div className="flex justify-between">
							...
							<kbd className="px-1.5 py-0.5 bg-muted text-muted-foreground border border-border text-[10px] font-mono">Ctrl+K</kbd>
						</div>
						<div className="flex justify-between">
