...
import { initAuth, createInvite, getAllUsers, revokeUser, unrevokeUser } from "./auth";
...
├──────────────────┼──────────┼──────────┼──────────────────────────────┤`);
      ...
      for (const user of users) {
        ...
        console.log(`│  ${user.name.padEnd(16)}│  ${statusColor.padEnd(8)}│  ${keys.padEnd(8)}│  ${lastUsed.padEnd(28)}│`);
      }
